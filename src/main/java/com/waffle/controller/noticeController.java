...
public class noticeController {
	...
	public String delete(NoticeVO boardVO, @ModelAttribute("scri") NoticeSearchCri scri, RedirectAttributes rttr)
			throws Exception {
		logger.info("delete");
	...
	public String replyUpdate(NoticeReVO vo, NoticeSearchCri scri, RedirectAttributes rttr) throws Exception {
	  ...
	  public String replyDeleteView(NoticeReVO vo, NoticeSearchCri scri, Model
	  model) throws Exception { logger.info("reply Write");
