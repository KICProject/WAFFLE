...
<head>
	...
	<style type="text/css">
		...
		.update_btn { background-color:#afde77; }
		.cancle {margin-right:0;}
	</style>
</head>
<script>
	$(function(){
			...
			<div class="input">
				<form action="/member/register" method="post" id="updateForm">
					<div class="updategrp">
				        ...
				        <input type="text" class="input-control" id="memId" name="memId"  value="${member.memId }" readonly>				        
				 	</div>
				   <!-- 비밀번호 -->
				    ...
				    <div class="updategrp">
				        ...
				        <input type="text" class="input-control" id="memName" name="memName" value="${member.memName }" required>
				    </div>
				    <!-- 생년월일 -->
				    <div class="updategrp">
				        <label for="memBirth">생년월일</label>
				        <input type="text" class="input-control" id="memBirth" name="memBirth" value="${member.memBirth}" required>
				    </div>
				    <!-- 본인확인 이메일 -->
				    <div class="updategrp ">
				        <label for="memEmail">이메일</label>
				        <input type="text" class="input-control" name="memEmail" id="memEmail" value="${member.memEmail}" readonly>	       
				    </div>
				    <!-- 휴대전화 -->
				    <div class="updategrp memPhone">
				        <label for="memPhone">휴대전화<br>('-' 없이 번호만 입력)</label>
				        <input type="text" class="input-control" id="memPhone" name="memPhone" value="${member.memPhone}" required>
				    </div>
				    <div class="updategrp memPhone2">
				        <label for="memPhone2">비상시연락처<br>('-' 없이 번호만 입력)</label>
				        <input type="text" class="input-control" id="memPhone2" name="memPhone2" value="${member.memPhone2}" required>
				    </div>
				    <div class="updategrp">
				        <label for="memAddr">주소</label>
				        <input type="text" class="input-control" id="memAddr" name="memAddr" value="${member.memAddr}"required>
				    </div>
